...
// 11.	Import juga fungsi store cookie untuk menyimpan token hasil login seperti berikut
import { setCookie } from "@/lib/client-cookies"
// 12.	import library axios untuk mengakses API
import axios from "axios"
// 13.	import fungsi Image untuk menampilkan gambar
import Image from "next/image"
// 14.	import use router untuk navigasi halaman setelah login berhasil
import { useRouter } from "next/navigation"
// 15.	import Form Event untuk form dan use state untuk membuat state
import { FormEvent, useState } from "react"
// 16.	Import toastify untuk menampilkan toast berhasil / gagal login
    ...
    return (
        <div className="w-screen h-screen bg-login bg-cover">
            ...
            <div className="w-full h-full bg-backdrop-login flex justify-center items-center p-5">
                <div className="w-full md:w-6/12 lg:w-4/12 min-h-[600px] border rounded-xl bg-blue-500 p-5 flex flex-col items-center relative">
                    <div className="absolute bottom-0 left-0 w-full py-2 text-center">
                        <small className="text-white">Copyright @2024</small>
                    </div>
 
                    <Image alt="moklet-app" width={150} height={100} src={`/ewing.jpg`}
                    ...
                    <form onSubmit={handleSubmit} className="w-full my-10">
                       <div className="flex w-full my-4">
                           ...
                           <input type="text" className="border p-2 grow rounded-r-md focus:outline-none focus:ring-primary text-black focus:border-primary" value={email}
                       ...
                       <div className="flex w-full my-4">
                           ...
                           <input type={showPassword ? `text` : `password`} className="border p-2 text-black  grow focus:outline-none focus:ring-primary focus:border-primary" value={password}
                       ...
                       <div className="my-10">
                           <button type="submit" className="bg-green-500 hover:bg-green-400 uppercase w-full p-2 rounded-md text-white">
                               Login
                           </button>
                       </div>
                   </form>
