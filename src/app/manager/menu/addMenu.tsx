"use client"
// 3.	Tambahkan import untuk library dan component yang digunakan
...
// 4.	Tambahkan component AddMenu sebagai berikut
const AddMenu = () => {
   // kode selanjutnya disini
    const [isShow, setIsShow] = useState<boolean>(false)

// 6.	Tambahkan inisiasi data awal untuk menu
    const [menu, setMenu] = useState<IMenu>({
        id: 0, uuid : ``, name : ``, price : 0, description : ``,
        category: ``, picture : ``, createdAt : ``, updatedAt : ``
    })
    
// 7.	Tambahkan router untuk navigasi halaman
    const router = useRouter()

// 8.	Tambahkan token untuk mengambil data dari cookie
    const TOKEN = getCookie("token") || ""

    const [file, setFile] = useState<File | null>(null)
    const formRef = useRef<HTMLFormElement>(null)
// 10.	Tambahkan fungsi openModal yang akan dijalankan saat tombol tambah data ditekan
    const openModal = () => {
        setMenu({
            id: 0, uuid : ``, name : ``, price : 0, description : ``,
            category: ``, picture : ``, createdAt : ``, updatedAt : ``
...
// 11.	Tambahkan fungsi handleSubmit yang akan dieksekusi saat tombol submit ditekan
