...
export const InputGroupComponent = ({ value, onChange, type, className, id, required, placeholder, children, label, onKeyUp, readOnly }: Props) => {
   return (
       <div className="w-full flex flex-col gap-1 my-2 text-black">
           <strong className="text-xs font-bold text-black">{label}{required == true ? <sup className="text-red-600">*&#41;</sup> : <></>}</strong>
