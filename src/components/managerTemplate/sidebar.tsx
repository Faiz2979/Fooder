...
import MenuItem from "./menuItem"
    ...
    const handleLogout = () => {
        ...
        return (
            <div className="w-full min-h-dvh bg-blue-500">
                {/* header section */}
           ...
           {/* sidebar section */}
            ...
            bg-blue-500 border-r border-primary ${isShow ? `translate-x-full` : ``}`}>
                ...
                <div className="mb-3 w-full flex justify-center">
                    <div className="flex items-center space-x-2">
                        <Image src="/ewing.jpg" alt="Logo" width={40} height={40} />
                ...
                <div className="w-full mt-10 mb-6 bg-primary text-white p-3 flex gap-2 items-center">
                    <Image src="/ewing.jpg" alt="Profile" width={40} height={40} className="rounded-full" />
